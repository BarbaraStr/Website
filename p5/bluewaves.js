...
let inter = 5; // difference between the sizes of two blobs
let maxNoise = 300;
...
function draw() {
 ...
 // blob(size*vol+800, width/2, height/2, k, t - i * step + 0.1, noisiness);
    ...
    blob(size*vol+500, width, height/2, k, t - i * step + 1, noisiness*5);
		
		fill(0, 0, 255, alpha*20);
    blob(size*vol+500, 0, height/2, k, t - i * step + 0.2, noisiness*5);
